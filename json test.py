...
# https://docs.google.com/spreadsheets/d/1QN0SomW13tQnGsC0cyW9qZ967qxMF44VclCr2dhUljQ/edit?usp=sharing
...
if page == "📊 หน้าแสดงผล rate และ ชั่วโมงที่เหลือ":
    ...
    sheet_url = "https://docs.google.com/spreadsheets/d/1QN0SomW13tQnGsC0cyW9qZ967qxMF44VclCr2dhUljQ/edit?usp=sharing"
    ...
    sheet_id = "1QN0SomW13tQnGsC0cyW9qZ967qxMF44VclCr2dhUljQ"
...
# --------------------------------------------------- PAGE 2 -------------------------------------------------
    ...
    creds = Credentials.from_service_account_info(service_account_info, scopes=["https://www.googleapis.com/auth/spreadsheets"])
    gc = gspread.authorize(creds)
    sh = gc.open_by_url("https://docs.google.com/spreadsheets/d/1QN0SomW13tQnGsC0cyW9qZ967qxMF44VclCr2dhUljQ/edit?usp=sharing")
